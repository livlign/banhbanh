    ...
    public class QuickTable : WebControl, INamingContainer
    {
        ...
        private void AddHeaderText(TableSchema.TableColumn tableColumn, HtmlTableCell tdHeaderCell, string overrideText)
        {
            if(showSort)
            {
                ...
                btn.ID = "btn" + tableColumn.ColumnName;
                btn.CommandArgument = tableColumn.ColumnName;

                btn.Text = String.IsNullOrEmpty(overrideText) ? tableColumn.DisplayName : overrideText;
        ...
        private void LoadGrid()
        {
            ...
            q.SelectColumnList = selectList.ToString().Split(new char[] {','}, StringSplitOptions.RemoveEmptyEntries);
        ...
        protected override void CreateChildControls()
        {
            ...
            if(schema == null)
                schema = DataService.GetSchema(tableName, ProviderName, TableType.View);
            if(schema == null)
