...
namespace SubSonic
{
    ...
    public class OrderBy
    {
        ...
        public static OrderBy Desc(TableSchema.TableColumn tableColumn, string tableAlias)
        {
            ...
            orderBy.orderString = Utility.QualifyColumnName(tableAlias, tableColumn.ColumnName, tableColumn.Table.Provider) + SqlFragment.DESC;
            return orderBy;
        }
        ...
        {
            OrderBy orderBy = new OrderBy();
            orderBy.orderString = tableColumn.QualifiedName + SqlFragment.DESC;
            return orderBy;
        }
        ...
        {
            OrderBy orderBy = new OrderBy();
            orderBy.orderString = "[" + columnName + "]" + SqlFragment.DESC;
            return orderBy;
        }
        ...
        {
            OrderBy orderBy = new OrderBy();
            orderBy.orderString = Utility.QualifyColumnName(tableAlias, tableColumn.ColumnName, tableColumn.Table.Provider) + SqlFragment.ASC;
            return orderBy;
        }
        ...
        {
            OrderBy orderBy = new OrderBy();
            orderBy.orderString = tableColumn.QualifiedName + SqlFragment.ASC;
            return orderBy;
        }
        ...
        {
            OrderBy orderBy = new OrderBy();
            orderBy.orderString = "[" + columnName + "]" + SqlFragment.ASC;
            return orderBy;
        }
    ...
    public class Query
    {
        ...
        private bool _aliasForeignKeys;
        ...
        public bool AliasForeignKeys
        {
            get { return _aliasForeignKeys; }
            set { _aliasForeignKeys = value; }
        }
        ...
        {
            get { return _logicalDeleteColumn; }
            set { _logicalDeleteColumn = value; }
        }
