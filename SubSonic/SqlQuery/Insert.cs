...
namespace SubSonic
{
    public class InsertSetting
    {
        ...
        public bool IsExpression
        {
            ...
            internal set { _isExpression = value; }
        }
    }
    ...
    public class Insert
    {
        ...
        private SqlQuery _selectValues;
        private TableSchema.Table _table;
        ...
        public SqlQuery SelectValues
        {
            get { return _selectValues; }
            internal set { _selectValues = value; }
        }
        ...
        public int Execute()
        {
            ...
            if(provider != null)
                ...
                cmd = new QueryCommand(sql, DataService.Provider.Name); //Uses default provider
