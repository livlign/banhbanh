...
namespace SubSonic
{
    ...
    public class SqlQuery
    {
        ...
        public Constraint Where(TableSchema.TableColumn column)
        {
            ...
            c.TableName = column.Table.TableName;
            c.DbType = column.DataType;
            c.Column = column;
            return c;
        }
        ...
        public SqlQuery OpenExpression()
        {
            ...
            c.Comparison = Comparison.OpenParentheses;
            Constraints.Add(c);
            OpenParenCount++;
            return this;
        }
        ...
        {
            Constraint c = new Constraint(ConstraintType.Where, "##", "##", "##", this);
            c.Comparison = Comparison.CloseParentheses;
            Constraints.Add(c);
            ClosedParenCount++;
            return this;
        }
        ...
        public int CurrentPage
        {
            ...
            internal set { _currentPage = value; }
        }

        public int OpenParenCount
        {
            get { return _openParenCount; }
            internal set { _openParenCount = value; }
        }

        public int ClosedParenCount
        {
            get { return _closedParenCount; }
            internal set { _closedParenCount = value; }
        }
