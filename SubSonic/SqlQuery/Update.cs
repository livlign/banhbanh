...
namespace SubSonic
{
    ...
    public class Update : SqlQuery
    {
        ...
        private Setting CreateSetting(string columnName, DbType dbType, bool isExpression)
        {
            ...
            s.ParameterName = Utility.PrefixParameter(String.Concat("up_", Utility.StripNonAlphaNumeric(columnName)), Provider);
            s.IsExpression = isExpression;
            s.DataType = dbType;
            return s;
        }
